...
dict={"Ab_Inbev":"CL023","AG_Barr":"CL005","Bacardi":"CL001"
...
def get_potential_claims(dir):
    ...
    for folder in folders:
        # if folder != 'Loreal':continue
        for file in os.listdir(os.path.join(dir,folder)):
            if file.endswith(".xlsx"):
                files.append(os.path.join(dir,folder,file))
    return files
...
file_list=get_potential_claims(r"W:\Admin\Claims Db\Pricing Claims\COOP")
df=[]
