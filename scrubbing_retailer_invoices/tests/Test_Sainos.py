...
def data_extraction(base_path):
    for filename in listdir_nohidden(base_path):
        text=Read_pdf(os.path.join(r"C:\Users\Python\Desktop\test\Incomplete",filename))
        ...
        if Invoice_No in check_list:
            try:
                os.rename(os.path.join(r"C:\Users\Python\Desktop\test\Incomplete",filename),os.path.join(r"C:\Users\Python\Desktop\test\Complete",filename))
            except:
                os.replace(os.path.join(r"C:\Users\Python\Desktop\test\Incomplete",filename),os.path.join(r"C:\Users\Python\Desktop\test\Complete",filename))
        else:continue
...
data_extraction(r"C:\Users\Python\Desktop\test\Incomplete")
