...
for Retailer in Retailer_List:
    if Retailer == "Asda":
        ...
        # If there are files in the unsplit files folder, remove them
        ...
        # If there are files in the split files folder, remove them
        ...
        # If there are files in the incomplete folder, remove files from the incomplete folder that are already in the invoice image folder
        ...
        # If there are files in the complete folder, remove files from the complete folder that are already in the invoice image folder
        ...
        # Ignore the thumbs.db and desktop.ini files
        for file in os.listdir(Email_Staging_path.format(Client, Retailer)):
            if file == "Thumbs.db":
                pass
            elif file == "desktop.ini":
                ...
                pass
            # If the file is a PDF, it checks to see if the file exists in the invoice image folder. If it is, it removes the file from the email staging bay. 
            # If it doesn't exist, it moves the file to the unsplit files folder
            if ".PDF" in file or ".pdf" in file:
                if os.path.isfile(Invoice_Image_Folder_path_2.format(Client,file)):
                    os.remove(Email_Staging_path_2.format(Client, Retailer, file))
                else:
        ...
        # Remove files from the incomplete folder that are already in the invoice image folder
        for file in os.listdir(r"C:\Users\python\Desktop\test\Incomplete"):
            #if file exists remove else move
            if os.path.isfile(Invoice_Image_Folder_path_2.format(Client,file)):
                os.remove(r"C:\Users\python\Desktop\test\Incomplete\{}".format(file))
