...
def file_splitter(base_path):
    for filename in listdir_nohidden(base_path):
        ...
        for i in range(len(input_pdf.pages)):
            ...
            with open(r"C:\Users\Python\Desktop\Morrisons test\Split Files\File"+str(i)+filename, "wb") as output_stream:
...
def unique_files(base_path,filenames,Invoice_Nos):
    for i in range(len(filenames)):
        if filenames in merged:continue
            ...
            with open(r"C:\Users\Python\Desktop\Morrisons test\Incomplete\\"+Invoice_Nos[i]+".pdf", "wb") as output_stream:
                output.write(output_stream)

file_splitter(r"C:\Users\Python\Desktop\Morrisons test\Unsplit Files")
define_pdfs(r"C:\Users\Python\Desktop\Morrisons test\Split Files")
unique_files(r"C:\Users\Python\Desktop\Morrisons test\Split Files",filenames,Invoice_Nos)
