...
promo_form_path=r'C:\Users\Email\Desktop\Oli PDF\PDF Reader\Promo Schedule Automation\SAINSBURY\Promo_forms'
Line_desc_path=r'C:\Users\Email\Desktop\Oli PDF\PDF Reader\Consistent Refrences for all clients'
#Useful csv
df=pd.read_csv(r'C:\Users\Email\Desktop\Oli PDF\PDF Reader\Consistent Refrences for all clients\Line_desc_Sainsbury.csv')
df2=pd.read_csv(r'C:\Users\Email\Desktop\Oli PDF\PDF Reader\Promo Schedule Automation\SAINSBURY\CPC.csv')
df3=pd.read_csv(r'C:\Users\Email\Desktop\Oli PDF\PDF Reader\Promo Schedule Automation\SAINSBURY\EPOS\CSV\Maxxium_std_price.csv')
#Column Headers
            ...
            for line in text.split('\n'):
                ...
                if Promo_comments:
                    ...
                    if save:
                        ...
                        print(Retailer_promotion_description)
                        action=input("Save or only? ")
                        action_amt=input("Amount? ")
                elif Promo_description_2 and not Promo_description_1:
                    print('Mechanic error')
                    break
                elif Promo_Start:
...
def into_data_frame(lines,df2):
    ...
    df1.to_csv('Promo_form.csv',index=True)
...
Salitix_customer_number=input("Retailer/Customer number? ")
Year=input("What year are you working on? ")
